                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>LinkedIn:</strong> 
                            <a href="https:" target="_blank">David Bryan no LinkedIn</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>LinkedIn:</strong> 
                            <a href="https:" target="_blank">Felipe Fernandes no LinkedIn</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>LinkedIn:</strong> 
                            <a href="https:" target="_blank">Robertha Rezende no LinkedIn</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>LinkedIn:</strong> 
                            <a href="https:" target="_blank">Victor Araújo no LinkedIn</a>
                        </p>
                    </div>
                </div>
            </div>
